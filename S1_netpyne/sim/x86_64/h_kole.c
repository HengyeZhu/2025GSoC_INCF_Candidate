...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 0, "cvodeieq");
 	...
 	ivoc_help("help ?1 ih /home/gluciferd/2025GSoC_INCF_Candidate/S1_netpyne/sim/mod/h_kole.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/gluciferd/2025GSoC_INCF_Candidate/S1_netpyne/sim/mod/h_kole.mod";
static const char* nmodl_file_text = 
  "TITLE Ih-current\n"
