...
def step_current_omv():
    ...
    netdoc = read_neuroml2_file("L1_DLAC_cNAC187_1_cell.nml")
    L1_DLAC_cNAC187_1_cell = netdoc.cells[0]
    net = netdoc.add(neuroml.Network, id="L1_DLAC_cNAC187_1_cell_net", validate=False)
    pop = net.add(neuroml.Population, id="L1_DLAC_cNAC187_1_cellpop", component=L1_DLAC_cNAC187_1_cell.id, size=1)
    ...
    write_neuroml2_file(netdoc, "L1_DLAC_cNAC187_1_cell.net.nml")

    generate_lems_file_for_neuroml(
        sim_id="L1_DLAC_cNAC187_1_cell_step_test",
        target=net.id,
        neuroml_file="L1_DLAC_cNAC187_1_cell.net.nml",
        duration="3000ms",
        dt="0.01ms",
        lems_file_name="LEMS_L1_DLAC_cNAC187_1_cell_step_test.xml",
        nml_doc=netdoc,
    ...
    data = run_lems_with_jneuroml_neuron(
        "LEMS_L1_DLAC_cNAC187_1_cell_step_test.xml", load_saved_data=True, compile_mods=True
    )
    ...
    generate_plot(
        xvalues=[data["t"]],
        yvalues=[data["L1_DLAC_cNAC187_1_cell_pop[0]/v"]],
        title="Membrane potential: L1_DLAC_cNAC187_1_cell",
    )
