...
#define i__Ca _p[17]
#define i__Ca_columnindex 17
#define m_forwardRate_x _p[18]
#define m_forwardRate_x_columnindex 18
#define m_forwardRate_r _p[19]
#define m_forwardRate_r_columnindex 19
#define m_reverseRate_r _p[20]
#define m_reverseRate_r_columnindex 20
#define m_rateScale _p[21]
#define m_rateScale_columnindex 21
#define m_alpha _p[22]
#define m_alpha_columnindex 22
#define m_beta _p[23]
#define m_beta_columnindex 23
#define m_fcond _p[24]
#define m_fcond_columnindex 24
#define m_inf _p[25]
...
#define h_reverseRate_r _p[28]
#define h_reverseRate_r_columnindex 28
#define h_rateScale _p[29]
#define h_rateScale_columnindex 29
#define h_alpha _p[30]
#define h_alpha_columnindex 30
#define h_beta _p[31]
#define h_beta_columnindex 31
#define h_fcond _p[32]
#define h_fcond_columnindex 32
#define h_inf _p[33]
#define h_inf_columnindex 33
#define h_tau _p[34]
#define h_tau_columnindex 34
#define conductanceScale _p[35]
#define conductanceScale_columnindex 35
#define fopen0 _p[36]
#define fopen0_columnindex 36
#define fopen _p[37]
#define fopen_columnindex 37
#define g _p[38]
#define g_columnindex 38
#define m_q _p[39]
#define m_q_columnindex 39
#define h_q _p[40]
#define h_q_columnindex 40
#define temperature _p[41]
#define temperature_columnindex 41
#define eca _p[42]
#define eca_columnindex 42
#define ica _p[43]
#define ica_columnindex 43
#define rate_m_q _p[44]
#define rate_m_q_columnindex 44
#define rate_h_q _p[45]
#define rate_h_q_columnindex 45
#define Dm_q _p[46]
#define Dm_q_columnindex 46
#define Dh_q _p[47]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 Ca /home/gluciferd/2025GSoC_INCF_Project12/S1_neuroml/cell_nml/L1_DLAC_cNAC187_1/sim/Ca.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/gluciferd/2025GSoC_INCF_Project12/S1_neuroml/cell_nml/L1_DLAC_cNAC187_1/sim/Ca.mod";
static const char* nmodl_file_text = 
  "TITLE Mod file for component: Component(id=Ca type=ionChannelHH)\n"
  "\n"
  "COMMENT\n"
  "\n"
  ...
  "    \n"
  "    RANGE gion\n"
  "    RANGE i__Ca : a copy of the variable for current which makes it easier to access from outside the mod file\n"
  ...
  "    m_forwardRate_rate = 0.209 (kHz)       : was: 209.0 (per_time)\n"
  "    m_forwardRate_midpoint = -27 (mV)      : was: -0.027 (voltage)\n"
  "    m_forwardRate_scale = 3.8 (mV)         : was: 0.0038 (voltage)\n"
  "    m_reverseRate_rate = 0.94000006 (kHz)  : was: 940.0 (per_time)\n"
  "    m_reverseRate_midpoint = -75 (mV)      : was: -0.075 (voltage)\n"
  "    m_reverseRate_scale = -17 (mV)         : was: -0.017 (voltage)\n"
  "    h_instances = 1                        : was: 1.0 (none)\n"
  "    h_forwardRate_rate = 4.5700002E-4 (kHz): was: 0.457 (per_time)\n"
  "    h_forwardRate_midpoint = -13 (mV)      : was: -0.013000000000000001 (voltage)\n"
  "    h_forwardRate_scale = -50 (mV)         : was: -0.05 (voltage)\n"
  "    h_reverseRate_rate = 0.0065 (kHz)      : was: 6.5 (per_time)\n"
  "    h_reverseRate_midpoint = -15 (mV)      : was: -0.015 (voltage)\n"
  "    h_reverseRate_scale = 28 (mV)          : was: 0.028 (voltage)\n"
  "}\n"
  "\n"
  "ASSIGNED {\n"
  "    \n"
  ...
  "    \n"
  "    ? DerivedVariable is based on path: conductanceScaling[*]/factor, on: Component(id=Ca type=ionChannelHH), from conductanceScaling; null\n"
  "    ? Path not present in component, using factor: 1\n"
  "    \n"
  "    conductanceScale = 1 \n"
  "    \n"
  "    ? DerivedVariable is based on path: gates[*]/fcond, on: Component(id=Ca type=ionChannelHH), from gates; Component(id=m type=gateHHrates)\n"
  ...
  "    \n"
  "    ica = gion * (v - eca)\n"
  "    i__Ca =  -1 * ica : set this variable to the current also - note -1 as channel current convention for LEMS used!\n"
  "    \n"
  "}\n"
  "\n"
  "DERIVATIVE states {\n"
