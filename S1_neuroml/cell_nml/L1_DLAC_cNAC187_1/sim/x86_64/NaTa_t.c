...
#define i__NaTa_t _p[19]
#define i__NaTa_t_columnindex 19
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "cvodeieq");
 	...
 	ivoc_help("help ?1 NaTa_t /home/gluciferd/2025GSoC_INCF_Project12/S1_neuroml/cell_nml/L1_DLAC_cNAC187_1/sim/NaTa_t.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/gluciferd/2025GSoC_INCF_Project12/S1_neuroml/cell_nml/L1_DLAC_cNAC187_1/sim/NaTa_t.mod";
static const char* nmodl_file_text = 
  ...
  "    \n"
  "    RANGE gion\n"
  "    RANGE i__NaTa_t : a copy of the variable for current which makes it easier to access from outside the mod file\n"
  ...
  "    h_forwardRate_midpoint = -66 (mV)      : was: -0.066 (voltage)\n"
  "    h_forwardRate_scale = -6 (mV)          : was: -0.006 (voltage)\n"
  "    h_reverseRate_rate = 0.09 (kHz)        : was: 90.0 (per_time)\n"
  "    h_reverseRate_midpoint = -66 (mV)      : was: -0.066 (voltage)\n"
  ...
  "    \n"
  "    ina = gion * (v - ena)\n"
  "    i__NaTa_t =  -1 * ina : set this variable to the current also - note -1 as channel current convention for LEMS used!\n"
  "    \n"
  "}\n"
  "\n"
  "DERIVATIVE states {\n"
