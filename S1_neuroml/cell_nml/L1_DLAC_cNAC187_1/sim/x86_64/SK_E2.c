...
#define i__SK_E2 _p[10]
#define i__SK_E2_columnindex 10
#define z_timeCourse_V _p[11]
#define z_timeCourse_V_columnindex 11
#define z_timeCourse_ca_conc _p[12]
#define z_timeCourse_ca_conc_columnindex 12
#define z_timeCourse_t _p[13]
#define z_timeCourse_t_columnindex 13
#define z_steadyState_V _p[14]
#define z_steadyState_V_columnindex 14
#define z_steadyState_ca_conc _p[15]
#define z_steadyState_ca_conc_columnindex 15
#define z_steadyState_x _p[16]
#define z_steadyState_x_columnindex 16
#define z_rateScale _p[17]
#define z_rateScale_columnindex 17
#define z_fcond _p[18]
#define z_fcond_columnindex 18
#define z_inf _p[19]
#define z_inf_columnindex 19
#define z_tauUnscaled _p[20]
#define z_tauUnscaled_columnindex 20
#define z_tau _p[21]
#define z_tau_columnindex 21
#define conductanceScale _p[22]
#define conductanceScale_columnindex 22
#define fopen0 _p[23]
#define fopen0_columnindex 23
#define fopen _p[24]
#define fopen_columnindex 24
#define g _p[25]
#define g_columnindex 25
#define z_q _p[26]
#define z_q_columnindex 26
#define temperature _p[27]
#define temperature_columnindex 27
#define ek _p[28]
...
#define cao _p[31]
#define cao_columnindex 31
#define rate_z_q _p[32]
#define rate_z_q_columnindex 32
#define Dz_q _p[33]
#define Dz_q_columnindex 33
#define v _p[34]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 SK_E2 /home/gluciferd/2025GSoC_INCF_Project12/S1_neuroml/cell_nml/L1_DLAC_cNAC187_1/sim/SK_E2.mod\n");
...
static void _initlists(){
 ...
 int _i; static int _first = 1;
  if (!_first) return;
 _slist1[0] = z_q_columnindex;  _dlist1[0] = Dz_q_columnindex;
_first = 0;
}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/gluciferd/2025GSoC_INCF_Project12/S1_neuroml/cell_nml/L1_DLAC_cNAC187_1/sim/SK_E2.mod";
static const char* nmodl_file_text = 
  ...
  "    \n"
  "    RANGE gion\n"
  "    RANGE i__SK_E2 : a copy of the variable for current which makes it easier to access from outside the mod file\n"
  ...
  "    z_instances = 1                        : was: 1.0 (none)\n"
  "    z_timeCourse_TIME_SCALE = 1 (ms)       : was: 0.001 (time)\n"
  "    z_timeCourse_VOLT_SCALE = 1 (mV)       : was: 0.001 (voltage)\n"
  "    z_timeCourse_CONC_SCALE = 1000000 (mM) : was: 1000000.0 (concentration)\n"
  "    z_steadyState_TIME_SCALE = 1 (ms)      : was: 0.001 (time)\n"
  "    z_steadyState_VOLT_SCALE = 1 (mV)      : was: 0.001 (voltage)\n"
  "    z_steadyState_CONC_SCALE = 1000000 (mM): was: 1000000.0 (concentration)\n"
  "}\n"
  "\n"
  "ASSIGNED {\n"
  "    \n"
  ...
  "    \n"
  "    ik = gion * (v - ek)\n"
  "    i__SK_E2 =  -1 * ik : set this variable to the current also - note -1 as channel current convention for LEMS used!\n"
  "    \n"
  "}\n"
  "\n"
  "DERIVATIVE states {\n"
  ...
  "    ? DerivedVariable is based on path: steadyState/x, on: Component(id=z type=gateHHtauInf), from steadyState; Component(id=null type=SK_E2_z_inf)\n"
  "    z_inf = z_steadyState_x ? path based, prefix = z_\n"
  "    \n"
  "    ? DerivedVariable is based on path: timeCourse/t, on: Component(id=z type=gateHHtauInf), from timeCourse; Component(id=null type=SK_E2_z_tau)\n"
