...
#define i__Im _p[11]
#define i__Im_columnindex 11
#define m_forwardRate_r _p[12]
#define m_forwardRate_r_columnindex 12
#define m_reverseRate_r _p[13]
#define m_reverseRate_r_columnindex 13
#define m_q10Settings_q10 _p[14]
#define m_q10Settings_q10_columnindex 14
#define m_rateScale _p[15]
#define m_rateScale_columnindex 15
#define m_alpha _p[16]
#define m_alpha_columnindex 16
#define m_beta _p[17]
#define m_beta_columnindex 17
#define m_fcond _p[18]
#define m_fcond_columnindex 18
#define m_inf _p[19]
#define m_inf_columnindex 19
#define m_tau _p[20]
#define m_tau_columnindex 20
...
#define rate_m_q _p[29]
#define rate_m_q_columnindex 29
#define Dm_q _p[30]
#define Dm_q_columnindex 30
#define v _p[31]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "cvodeieq");
 	...
 	ivoc_help("help ?1 Im /home/gluciferd/2025GSoC_INCF_Project12/S1_neuroml/cell_nml/L1_DLAC_cNAC187_1/sim/Im.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/gluciferd/2025GSoC_INCF_Project12/S1_neuroml/cell_nml/L1_DLAC_cNAC187_1/sim/Im.mod";
static const char* nmodl_file_text = 
  ...
  "    \n"
  "    RANGE gion\n"
  "    RANGE i__Im : a copy of the variable for current which makes it easier to access from outside the mod file\n"
  ...
  "    m_forwardRate_rate = 0.0033000002 (kHz): was: 3.3 (per_time)\n"
  "    m_forwardRate_midpoint = -35 (mV)      : was: -0.035 (voltage)\n"
  "    m_forwardRate_scale = 10 (mV)          : was: 0.01 (voltage)\n"
  "    m_reverseRate_rate = 0.0033000002 (kHz): was: 3.3 (per_time)\n"
  "    m_reverseRate_midpoint = -35 (mV)      : was: -0.035 (voltage)\n"
  "    m_reverseRate_scale = -10 (mV)         : was: -0.01 (voltage)\n"
  ...
  "    \n"
  "    ik = gion * (v - ek)\n"
  "    i__Im =  -1 * ik : set this variable to the current also - note -1 as channel current convention for LEMS used!\n"
  "    \n"
  "}\n"
  "\n"
  "DERIVATIVE states {\n"
