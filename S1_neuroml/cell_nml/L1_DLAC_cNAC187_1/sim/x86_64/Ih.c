...
#define i__Ih _p[10]
#define i__Ih_columnindex 10
#define m_forwardRate_x _p[11]
#define m_forwardRate_x_columnindex 11
...
#define ehcn _p[26]
#define ehcn_columnindex 26
#define ihcn _p[27]
#define ihcn_columnindex 27
...
#define _ion_ihcn	*_ppvar[0]._pval
#define _ion_dihcndv	*_ppvar[1]._pval
...
static void nrn_alloc(Prop* _prop) {
 ...
 prop_ion = need_memb(_hcn_sym);
 	_ppvar[0]._pval = &prop_ion->param[3]; /* ihcn */
 	_ppvar[1]._pval = &prop_ion->param[4]; /* _ion_dihcndv */
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 0, "hcn_ion");
  hoc_register_dparam_semantics(_mechtype, 1, "hcn_ion");
  hoc_register_dparam_semantics(_mechtype, 2, "cvodeieq");
 	hoc_register_cvode(_mechtype, _ode_count, _ode_map, _ode_spec, _ode_matsol);
 	hoc_register_tolerance(_mechtype, _hoc_state_tol, &_atollist);
 	hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 Ih /home/gluciferd/2025GSoC_INCF_Project12/S1_neuroml/cell_nml/L1_DLAC_cNAC187_1/sim/Ih.mod\n");
...
static void _ode_matsol(NrnThread* _nt, _Memb_list* _ml, int _type) {
 ...
 static void _update_ion_pointer(Datum* _ppvar) {
   nrn_update_ion_pointer(_hcn_sym, _ppvar, 0, 3);
   nrn_update_ion_pointer(_hcn_sym, _ppvar, 1, 4);
 }
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/gluciferd/2025GSoC_INCF_Project12/S1_neuroml/cell_nml/L1_DLAC_cNAC187_1/sim/Ih.mod";
static const char* nmodl_file_text = 
  ...
  "    \n"
  "    RANGE gion\n"
  "    RANGE i__Ih : a copy of the variable for current which makes it easier to access from outside the mod file\n"
  ...
  "    \n"
  "    ihcn = gion * (v - ehcn)\n"
  "    i__Ih =  -1 * ihcn : set this variable to the current also - note -1 as channel current convention for LEMS used!\n"
  "    \n"
  "}\n"
  "\n"
  "DERIVATIVE states {\n"
