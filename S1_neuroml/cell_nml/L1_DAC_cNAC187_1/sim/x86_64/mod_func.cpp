...
extern void _CaDynamics_E2__cNAC_1_axonal_reg(void);
extern void _CaDynamics_E2__cNAC_1_somatic_reg(void);
...
void modl_reg() {
  if (!nrn_nobanner_) if (nrnmpi_myid < 1) {
    ...
    fprintf(stderr, " \"CaDynamics_E2__cNAC_1_axonal.mod\"");
    fprintf(stderr, " \"CaDynamics_E2__cNAC_1_somatic.mod\"");
  ...
  _CaDynamics_E2__cNAC_1_axonal_reg();
  _CaDynamics_E2__cNAC_1_somatic_reg();
  _Ca_LVAst_reg();
  _Ca_reg();
  _Ih_reg();
  _Im_reg();
